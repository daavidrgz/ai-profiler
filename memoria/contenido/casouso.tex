...
\bigskip
{\color{blue}En lo que respecta al algoritmo de Martinc \cite{martinc2019hot}, vemos como, al aumentar el número de posts por usuario, aquellos clasificados como masculinos
...
política en Estados Unidos, es de tan solo un 20.5\%. A raíz de este hecho, podemos deducir que existió una menor participación de las mujeres en el movimiento \#BLM
en el marco de las redes sociales, lo que, a su vez, puede ofrecernos una información relevante sobre cuál fue la proporción real de cada género en las manifestaciones y protestas
sucedidas en la vida real.
...
como, a medida que aumenta el número de posts por usuario, el número de usuarios pertenecientes a la franja de edad 25-34 disminuye
considerablemente, mientras que los pertenecientes a los rangos 35-49 y 50-XX fluctúan.
...
puede deberse a que la gente más joven no haya vivido tantos episodios de racismo y, por lo tanto, no se sienta tan identificada con el movimiento.
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Distribución de edad obtenia por el algoritmo de Martinc at al., \cite{martinc2019hot}}
...
\begin{table}[H]
	...
	\caption{Distribución de edad obtenida por Martinc et al. \cite{martinc2019hot}}
...
\begin{table}[H]
	...
	\caption{Distribución de edad obtenida por Grivas et al. \cite{grivas2015author}}
	\label{tab:comparativa_edad_grivas}
\end{table}

\subsection{Otras características}

{\color{blue}En lo que respecta al perfilado de los rasgos personales que ofrece el algoritmo de Grivas et al. \cite{grivas2015author},
...
en Reddit sobre el \#BLM son personas que se muestran abiertas.
...
\begin{table}[H]
	...
	\caption{Distribución media de los rasgos personales obtenidos por Grivas et al. \cite{grivas2015author}}
...
\begin{table}[H]
	...
	\caption{Distribución de ocupación obtenida por Martinc et al. \cite{martinc2019hot}}
...
\begin{table}[H]
	...
	\caption{Distribución de fama obtenida por Martinc et al. \cite{martinc2019hot}}
