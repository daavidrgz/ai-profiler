...
ser procesadas por un ordenador. Entre todas ellas, las más relevantes son las siguientes:
...
\subsubsection{Análisis Semántico Latente}
...
\begin{table}[H]
	...
	\resizebox{0.85\textwidth}{!}{
		\begin{tabular}{|c|c|c|}
			\hhline{~--}
			\multicolumn{1}{c|}{\cellcolor{white}} & \textbf{Predicción Positiva} & \textbf{Predicción Negativa} \\ \hline
			\textbf{Real Positivo}                 & Verdadero Positivo (VP)      & Falso Negativo (FN)          \\ \hline
			\textbf{Real Negativo}                 & Falso Positivo (FP)          & Verdadero Negativo (VN)      \\ \hline
		\end{tabular}
	}
...
A partir de esta matriz, se pueden definir las siguientes métricas más comunes:
...
clases: \textit{18-24}, \textit{25-34}, \textit{35-49}, \textit{50-64} y \textit{65-XX}; donde la clase \textit{65-XX} representa cualquier edad igual o superior a 65 años.
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[fill=blue!20, pattern color=blue, postaction={pattern=north east lines}] table[x=Edad,y=Inglés] {
					Edad    Inglés
					18-24   1936
					25-34   3246
					35-49   3430
			...
			\addplot[fill=red!20, pattern color=red, postaction={pattern=dots}] table[x=Edad,y=Español] {
					Edad    Español
					18-24   346
					25-34   494
					35-49   425
...
con competición celebrada en año anterior, la cual cuenta con cerca de 12.000. Esto puede generar problemas de sobreajuste (\textit{overfitting} en inglés) en los modelos
entrenados con esta colección, fenómeno que limita en gran medida la generalización y empeora notablemente los resultados en casos de uso reales.
	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot[fill=blue!20] coordinates {(1,34630) (2,13655) (3,50)};
			\end{axis}
		\end{tikzpicture}
	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot[fill=red!20] coordinates {(1,36120) (2,10177) (3,2098)};
			\end{axis}
		\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[fill=violet!20] coordinates {(1,19285) (2,14178) (3,7811) (4,4009) (5,1141) (6,1094) (7,763) (8,54)};
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[color=orange, fill=orange!20] coordinates {(1940,105) (1941,128) (1942,135) (1943,182)
...
Este problema ha sido ampliamente reconocido por la comunidad, especialmente en el campo del aprendizaje automático y la inteligencia artificial.
...
obtuvo fue el de regresión logística, siendo empleado en todas las subtareas de clasificación de la competición. Para hallar dicha solución y obtener los hiperparámetros óptimos para cada
...
tiene que ver con heterogeneidad de los textos en el conjunto de entrenamiento, ya que se unificaron las publicaciones de los blogs, las reseñas de hoteles y
